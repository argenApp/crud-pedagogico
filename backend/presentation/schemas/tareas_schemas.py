# ═══════════════════════════════════════════════════════════════════════════════
# CAPA: PRESENTATION — Schemas Pydantic (DTOs HTTP)
#
...
#
# ¿Por qué está en presentation/schemas/ y no en adapters/?
#   En Clean Architecture, los schemas Pydantic son parte de la capa de Presentation:
#   son el "idioma HTTP" del sistema. Validan la forma de los datos que entran y salen
#   por la API REST. La capa de Presentation habla HTTP; la de Application habla DTOs.
#
...
class TareaResponse(BaseModel):
    ...
    El endpoint convierte una Entity (Tarea dataclass del Domain) a este schema
